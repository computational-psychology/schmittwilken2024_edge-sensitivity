...
# Model params
fos = [0.5, 1.3, 3., 5., 9.]              # center SFs of log-Gabor filters
...
outDir = "./outputs_5"        # directory to save filter outputs
...
params_dict = {
    "beta": np.linspace(0.5, 1.5, 2),
    "eta": np.linspace(0., 0.5, 2),
    "kappa": np.linspace(2., 4., 2),
    "alpha": alpha,
    "alpha2": alpha,
    "alpha3": alpha,
    "alpha4": alpha,
